            ...
            public void onClick(View v) {
                ...
                if(courseName.isEmpty() || courseNumber.isEmpty() || binding.editTextCourseHours.getText().toString().isEmpty()) {
                   Toast.makeText(getContext(), "Please enter all the fields", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(getContext(), "Your course hours must be greater then zero!!", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    db.gradeDAO().insertAll(new Grade(courseHours, courseLetterGrade, courseName, courseNumber));
